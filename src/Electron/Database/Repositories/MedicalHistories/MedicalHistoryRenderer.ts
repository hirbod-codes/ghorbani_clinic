...
export function handleRendererEvents(): RendererEvents {
    return {
        ...
        getMedicalHistories: async (): Promise<MainProcessResponse<MedicalHistory[]>> => JSON.parse(await ipcRenderer.invoke('get-medical-histories')),
...
export type RendererEvents = {
    ...
    getMedicalHistories(): Promise<MainProcessResponse<MedicalHistory[]>>;
