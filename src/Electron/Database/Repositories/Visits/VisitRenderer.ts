...
export function handleRendererEvents(): RendererEvents {
    return {
        ...
        getVisits: async (patientIdOffset?: string | number, count?: number): Promise<MainProcessResponse<Visit[]>> => JSON.parse(await ipcRenderer.invoke('get-visits', { patientIdOffset, count })),
...
export type RendererEvents = {
    ...
    getVisits(patientIdOffset?: string | number, count?: number): Promise<MainProcessResponse<Visit[]>>
